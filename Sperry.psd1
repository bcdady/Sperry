...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Update 1.10.2: Corrected $Settings references (with $MySettings variable name) in ProcessState.ps1. Improved Get-IECookie and Clear-IECookie Help examples and recursive cookie file inspection'
